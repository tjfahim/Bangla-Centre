                            ...
                            <div class="elementor-widget-container">
                                <ul class="elementor-icon-list-items elementor-inline-items">
                                    ...
                                    <li class="elementor-icon-list-item elementor-inline-item"> <span
                                            class="elementor-icon-list-icon"> <i aria-hidden="true"
                                                class="fas fa-envelope"></i> </span> <span
                                            class="elementor-icon-list-text">accounts@banglacentre.com</span> </li>
                                    <li class="elementor-icon-list-item elementor-inline-item"> <span
                                            class="elementor-icon-list-icon"> <i aria-hidden="true"
                            ...
                            <div class="elementor-widget-container">
                                <div class="elementor-social-icons-wrapper elementor-grid"> <span
                                        class="elementor-grid-item"> <a
                                            ...
                                            href="https://www.facebook.com/TheBanglaCentreSCIO" target="_blank"> <span
                                        ...
                                        class="elementor-grid-item"> <a
                                            ...
                                            href="https://twitter.com/home?lang=en%20UCbCKCrnuU2_iZNYSl9BnYZw" target="_blank"> <span
                                        ...
                                        class="elementor-grid-item"> <a
                                            ...
                                            href="https://www.linkedin.com/"  target="_blank"> <span class="elementor-screen-only">Linkedin</span> <i
                                        ...
                                        class="elementor-grid-item"> <a
                                            ...
                                            href="https://www.youtube.com/channel/UCbCKCrnuU2_iZNYSl9BnYZwn"  target="_blank"> <span class="elementor-screen-only">Youtube</span> <i
