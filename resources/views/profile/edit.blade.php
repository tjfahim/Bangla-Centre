                            ...
                            <form method="POST" action="{{ route('profile.update') }}">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input class="form-control mb-3 " type="text"  id="postCode"  name="post_code" value="{{ auth()->user()->post_code }}" required>
                                        <span id="post_code_error" style="color: red;"></span>
                                    </div>

                                </div>
                                <div class="form-outline mb-2 col-md-4 col-sm-4" style="padding-left:0">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input class="form-control mb-3 " type="text" name="address" id="address" value="{{ auth()->user()->address }}" required>
                                    </div>
